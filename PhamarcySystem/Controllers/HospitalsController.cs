...
namespace PhamarcySystem.Controllers
{
    ...
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HospitalId,HospitalName,CreatedBy,ModifiedBy,CreatedOn,ModifiedOn")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HospitalId,HospitalName,CreatedBy,ModifiedBy,CreatedOn,ModifiedOn")] Hospital hospital)
        {
