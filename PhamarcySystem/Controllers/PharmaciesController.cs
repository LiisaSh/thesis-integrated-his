...
namespace PhamarcySystem.Controllers
{
    ...
    public class PharmaciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PharmacyId,PharmancyName")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PharmacyId,PharmancyName")] Pharmacy pharmacy)
        {
